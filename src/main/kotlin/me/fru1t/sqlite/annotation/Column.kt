 ...
 * @param nullable Whether or not this column can be null
 ...
 * that this behavior is different in SQLite than it is in other SQL implementation. Please read
 * [the documentation][http://www.sqlite.org/autoinc.html] before using this field. TL;DR: if you
 * want an auto incremented `id` field, declare it a column as an integer and set it as the sole
 * [me.fru1t.sqlite.constraint.PrimaryKey] in the table. SQLite will magically take care of it.
 */
